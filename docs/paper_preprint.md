...
Published version: forthcoming (link will be added on Springer publication)

## Preprint

Zenodo: https://zenodo.org/records/19034554  
...
Singh, S.P., Gupta, M.K. (2025). AIoT Health: Medicine Reminder For The Elderly. 
Accepted: ICDECT-2025, Springer LNNS. 
Preprint: https://doi.org/10.5281/zenodo.19034554

## arXiv

Pending endorsement. Will be submitted to cs.LG once endorsed.
